...
pub struct Lineaggregate {
    ...
    pub case_sensitive: bool,     //if search is case sensitive
}
...
impl Lineaggregate {
    ...
    pub fn get(&mut self) -> Option<Simplelineaggregate> {
        ...
        let where_to_search = if self.case_sensitive {
            data
        } else {
            data.to_lowercase()
        };
...
fn test_b0_a0() {
    ...
    let mut d = Lineaggregate::new("Test", 0, 0, true);
    let mut pos = 0;
    for data in datas {
...
fn test_b1_a0() {
    ...
    let mut d = Lineaggregate::new("Test", 1, 0, true);
    let mut pos = 0;
    for data in datas {
        d.add(data.to_string());
        println!("  add {:?}", &d);
...
fn test_b0_a1() {
    ...
    let mut d = Lineaggregate::new("Test", 0, 1, true);
    let mut pos: i32 = -1;
    for data in datas {
        d.add(data.to_string());
        println!("  add {:?}", &d);
...
fn test_b1_a1() {
    ...
    let mut d = Lineaggregate::new("Test", 1, 1, true);
    let mut pos: i32 = -1;
    for data in datas {
        d.add(data.to_string());
        println!("  add {:?}", &d);
...
fn test_b3_a3() {
    ...
    let mut d = Lineaggregate::new("Test", 3, 3, true);
    let mut pos: i32 = -3;
    for data in datas {
        d.add(data.to_string());
        println!("  add {:?}", &d);
